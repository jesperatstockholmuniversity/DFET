...
<div class="mainpanel">
    ...
    {{Form::open(array('url'=>'/users/edit/'.$user->id,'method'=>'post', 'files' => true, 'class'=>'form-horizontal form-bordered'))}}
    <div class="row">           
	    <div class="col-md-7">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="group" name="group" data-placeholder="Choose One" class="width100p" required>
                                ...
                                <option value="{{$group->id}}" {{($group_name == $group->name) ? 'selected': '' }}>{{$group->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="permission" name="permission" data-placeholder="Choose One" class="width100p" required>
                                <option value="">Choose One</option>
                                <option value="1" {{(isset($user->permissions['admin'])) ? 'selected': '' }}>Administrator</option>
                                <option value="0" {{(isset($user->permissions['users'])) ? 'selected': '' }}>Normal User</option>
                            </select>
